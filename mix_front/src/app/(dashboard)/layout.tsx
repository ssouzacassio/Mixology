  ...
  return (
    <>
      <div className="md:hidden min-h-screen flex flex-col">
        <header className="flex items-center justify-between gap-3 border-b border-marca-azul/20 bg-marca-azul/5 px-4 py-3">
          <Image
            src="/marca/logo-colorida.png"
            alt="Mixology Drinkeria"
            width={120}
        ...
        <main className="flex-1 p-4 border-t-4 border-marca-laranja overflow-x-hidden">
          {children}
        </main>
      </div>
      ...
      <div className="hidden md:block">{conteudoDesktop}</div>
    </>
  );
}
